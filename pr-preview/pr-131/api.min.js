...
class AuroFloaterBib extends i$1 {
  ...
  firstUpdated() {
    ...
    this.dialog.addEventListener("keydown", (e) => {
      ...
      e.stopPropagation();
      // Dispatch on the host (auro-floater-bib) rather than back onto this.dialog.
      // Re-dispatching onto this.dialog would re-enter this same listener, causing
      // a recursive call even with a composed guard. Dispatching on this crosses
      // the shadow boundary without touching the dialog's listener again.
