...
```bash
origin  https://github.com/[yourUserName]/auro-drawer.git (fetch)
origin  https://github.com/[yourUserName]/auro-drawer.git (push)
```

To add the upstream repo to your local forked project

```bash
$ git remote add upstream https://github.com/AlaskaAirlines/auro-drawer.git
```
...
origin  https://github.com/[yourUserName]/auro-drawer.git (fetch)
origin  https://github.com/[yourUserName]/auro-drawer.git (push)
upstream        https://github.com/AlaskaAirlines/auro-drawer.git (fetch)
upstream        https://github.com/AlaskaAirlines/auro-drawer.git (push)
```
